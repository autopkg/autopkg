...
PkgCopier = importlib.import_module("autopkg.autopkglib.PkgCopier")
...
class TestPkgCopier(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.processor = PkgCopier.PkgCopier(infile=self.input_plist)

    def tearDown(self):
        pass

    @patch(f"{__name__}.PkgCopier.PkgCopier.copy")
