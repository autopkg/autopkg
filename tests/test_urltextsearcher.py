...
from autopkg.autopkglib.URLTextSearcher import NO_MATCH_MESSAGE

URLTextSearcher = importlib.import_module("autopkg.autopkglib.URLTextSearcher")
...
class TestURLTextSearcher(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.processor = URLTextSearcher.URLTextSearcher(infile=self.input_plist)
    ...
    @patch(f"{__name__}.URLTextSearcher.URLTextSearcher.download_with_curl")
