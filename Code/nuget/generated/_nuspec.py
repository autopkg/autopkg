...
class dependency(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, id=None, version=None, include=None, exclude=None, gds_collector_=None, **kwargs_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='dependency', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='dependency'):
        ...
        if self.include is not None and 'include' not in already_processed:
            ...
            outfile.write(' include=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.include), input_name='include')), ))
        if self.exclude is not None and 'exclude' not in already_processed:
            already_processed.add('exclude')
            outfile.write(' exclude=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.exclude), input_name='exclude')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='dependency', fromsubclass_=False, pretty_print=True):
        pass
...
class dependencyGroup(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'targetFramework': MemberSpec_('targetFramework', 'xs:string', 0, 1, {'use': 'optional'}),
        'dependency': MemberSpec_('dependency', 'dependency', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'dependency', 'type': 'dependency'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    def __init__(self, targetFramework=None, dependency=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, dependencyGroup)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='dependencyGroup', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='dependencyGroup')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='dependencyGroup', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='dependencyGroup'):
        if self.targetFramework is not None and 'targetFramework' not in already_processed:
            already_processed.add('targetFramework')
            outfile.write(' targetFramework=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.targetFramework), input_name='targetFramework')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='dependencyGroup', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def validate_(self, gds_collector, recursive=False):
        ...
        message_count = len(self.gds_collector_.get_messages())
        # validate simple type attributes
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.targetFramework, 'targetFramework')
        self.gds_check_cardinality_(self.targetFramework, 'targetFramework', required=False)
        # validate simple type children
        # validate complex type children
...
class reference(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='reference', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='reference', fromsubclass_=False, pretty_print=True):
        pass
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
...
class contentFileEntries(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'exclude': MemberSpec_('exclude', 'xs:string', 0, 1, {'use': 'optional'}),
        'buildAction': MemberSpec_('buildAction', 'xs:string', 0, 1, {'use': 'optional'}),
        'copyToOutput': MemberSpec_('copyToOutput', 'xs:boolean', 0, 1, {'use': 'optional'}),
        'flatten': MemberSpec_('flatten', 'xs:boolean', 0, 1, {'use': 'optional'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    def __init__(self, include=None, exclude=None, buildAction=None, copyToOutput=None, flatten=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='contentFileEntries', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='contentFileEntries')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='contentFileEntries', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='contentFileEntries'):
        if self.include is not None and 'include' not in already_processed:
            already_processed.add('include')
            outfile.write(' include=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.include), input_name='include')), ))
        if self.exclude is not None and 'exclude' not in already_processed:
        ...
        if self.buildAction is not None and 'buildAction' not in already_processed:
            ...
            outfile.write(' buildAction=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.buildAction), input_name='buildAction')), ))
        if self.copyToOutput is not None and 'copyToOutput' not in already_processed:
            already_processed.add('copyToOutput')
            outfile.write(' copyToOutput="%s"' % self.gds_format_boolean(self.copyToOutput, input_name='copyToOutput'))
        if self.flatten is not None and 'flatten' not in already_processed:
            already_processed.add('flatten')
            outfile.write(' flatten="%s"' % self.gds_format_boolean(self.flatten, input_name='flatten'))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='contentFileEntries', fromsubclass_=False, pretty_print=True):
        pass
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
        ...
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.exclude, 'exclude')
        self.gds_check_cardinality_(self.exclude, 'exclude', required=False)
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.buildAction, 'buildAction')
        self.gds_check_cardinality_(self.buildAction, 'buildAction', required=False)
        self.gds_validate_builtin_ST_(self.gds_validate_boolean, self.copyToOutput, 'copyToOutput')
        self.gds_check_cardinality_(self.copyToOutput, 'copyToOutput', required=False)
        self.gds_validate_builtin_ST_(self.gds_validate_boolean, self.flatten, 'flatten')
...
class referenceGroup(GeneratedsSuper):
    ...
    member_data_items_ = {
        'targetFramework': MemberSpec_('targetFramework', 'xs:string', 0, 1, {'use': 'optional'}),
        'reference': MemberSpec_('reference', 'reference', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'reference', 'type': 'reference'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    def __init__(self, targetFramework=None, reference=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, referenceGroup)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='referenceGroup', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='referenceGroup')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='referenceGroup', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='referenceGroup'):
        if self.targetFramework is not None and 'targetFramework' not in already_processed:
            already_processed.add('targetFramework')
            outfile.write(' targetFramework=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.targetFramework), input_name='targetFramework')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='referenceGroup', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def validate_(self, gds_collector, recursive=False):
        ...
        # validate simple type children
        # validate complex type children
        self.gds_check_cardinality_(self.reference, 'reference', min_occurs=1, max_occurs=9999999)
        if recursive:
...
class frameworkReference(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='frameworkReference', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='frameworkReference')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='frameworkReference', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='frameworkReference'):
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='frameworkReference', fromsubclass_=False, pretty_print=True):
        pass
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
...
class frameworkReferenceGroup(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'targetFramework': MemberSpec_('targetFramework', 'xs:string', 0, 0, {'use': 'required'}),
        'frameworkReference': MemberSpec_('frameworkReference', 'frameworkReference', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'frameworkReference', 'type': 'frameworkReference'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    def __init__(self, targetFramework=None, frameworkReference=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='frameworkReferenceGroup', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='frameworkReferenceGroup')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='frameworkReferenceGroup', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='frameworkReferenceGroup'):
        if self.targetFramework is not None and 'targetFramework' not in already_processed:
            already_processed.add('targetFramework')
            outfile.write(' targetFramework=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.targetFramework), input_name='targetFramework')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='frameworkReferenceGroup', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for frameworkReference_ in self.frameworkReference:
            namespaceprefix_ = self.frameworkReference_nsprefix_ + ':' if (UseCapturedNS_ and self.frameworkReference_nsprefix_) else ''
            frameworkReference_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='frameworkReference', pretty_print=pretty_print)
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
        # validate simple type attributes
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.targetFramework, 'targetFramework')
        self.gds_check_cardinality_(self.targetFramework, 'targetFramework', required=True)
        # validate simple type children
        # validate complex type children
        self.gds_check_cardinality_(self.frameworkReference, 'frameworkReference', min_occurs=0, max_occurs=9999999)
        if recursive:
...
class package(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'metadata': MemberSpec_('metadata', 'metadataType', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'metadata', 'type': 'metadataType'}, None),
        'files': MemberSpec_('files', 'filesType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'files', 'nillable': 'true', 'type': 'filesType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='package', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='package'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='package', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class metadataType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'minClientVersion': MemberSpec_('minClientVersion', 'xs:string', 0, 1, {'use': 'optional'}),
        'id': MemberSpec_('id', 'xs:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'id', 'type': 'xs:string'}, None),
        'version': MemberSpec_('version', 'xs:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'version', 'type': 'xs:string'}, None),
        'title': MemberSpec_('title', 'xs:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'title', 'type': 'xs:string'}, None),
        'authors': MemberSpec_('authors', 'xs:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'authors', 'type': 'xs:string'}, None),
        'owners': MemberSpec_('owners', 'xs:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'owners', 'type': 'xs:string'}, None),
        'licenseUrl': MemberSpec_('licenseUrl', 'xs:anyURI', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'licenseUrl', 'type': 'xs:anyURI'}, None),
        'projectUrl': MemberSpec_('projectUrl', 'xs:anyURI', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'projectUrl', 'type': 'xs:anyURI'}, None),
        'iconUrl': MemberSpec_('iconUrl', 'xs:anyURI', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'iconUrl', 'type': 'xs:anyURI'}, None),
        'requireLicenseAcceptance': MemberSpec_('requireLicenseAcceptance', 'xs:boolean', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'requireLicenseAcceptance', 'type': 'xs:boolean'}, None),
        'developmentDependency': MemberSpec_('developmentDependency', 'xs:boolean', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'developmentDependency', 'type': 'xs:boolean'}, None),
        'description': MemberSpec_('description', 'xs:string', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'description', 'type': 'xs:string'}, None),
        'summary': MemberSpec_('summary', 'xs:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'summary', 'type': 'xs:string'}, None),
        'releaseNotes': MemberSpec_('releaseNotes', 'xs:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'releaseNotes', 'type': 'xs:string'}, None),
        'copyright': MemberSpec_('copyright', 'xs:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'copyright', 'type': 'xs:string'}, None),
        'language': MemberSpec_('language', 'xs:string', 0, 1, {'default': 'en-US', 'maxOccurs': '1', 'minOccurs': '0', 'name': 'language', 'type': 'xs:string'}, None),
        'tags': MemberSpec_('tags', 'xs:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'tags', 'type': 'xs:string'}, None),
        'serviceable': MemberSpec_('serviceable', 'xs:boolean', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'serviceable', 'type': 'xs:boolean'}, None),
        'icon': MemberSpec_('icon', 'xs:string', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'icon', 'type': 'xs:string'}, None),
        'repository': MemberSpec_('repository', 'repositoryType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'repository', 'type': 'repositoryType'}, None),
        'license': MemberSpec_('license', 'licenseType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'license', 'type': 'licenseType'}, None),
        'packageTypes': MemberSpec_('packageTypes', 'packageTypesType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'packageTypes', 'type': 'packageTypesType'}, None),
        'dependencies': MemberSpec_('dependencies', 'dependenciesType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'dependencies', 'type': 'dependenciesType'}, None),
        'frameworkAssemblies': MemberSpec_('frameworkAssemblies', 'frameworkAssembliesType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'frameworkAssemblies', 'type': 'frameworkAssembliesType'}, None),
        'frameworkReferences': MemberSpec_('frameworkReferences', 'frameworkReferencesType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'frameworkReferences', 'type': 'frameworkReferencesType'}, None),
        'references': MemberSpec_('references', 'referencesType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'references', 'type': 'referencesType'}, None),
        'contentFiles': MemberSpec_('contentFiles', 'contentFilesType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'contentFiles', 'type': 'contentFilesType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    def __init__(self, minClientVersion=None, id=None, version=None, title=None, authors=None, owners=None, licenseUrl=None, projectUrl=None, iconUrl=None, requireLicenseAcceptance=None, developmentDependency=None, description=None, summary=None, releaseNotes=None, copyright=None, language='en-US', tags=None, serviceable=None, icon=None, repository=None, license=None, packageTypes=None, dependencies=None, frameworkAssemblies=None, frameworkReferences=None, references=None, contentFiles=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            self.licenseUrl is not None or
            self.projectUrl is not None or
            self.iconUrl is not None or
            self.requireLicenseAcceptance is not None or
            self.developmentDependency is not None or
            self.description is not None or
            self.summary is not None or
            self.releaseNotes is not None or
            self.copyright is not None or
            self.language != "en-US" or
            self.tags is not None or
            self.serviceable is not None or
            self.icon is not None or
            self.repository is not None or
            self.license is not None or
            self.packageTypes is not None or
            self.dependencies is not None or
            self.frameworkAssemblies is not None or
            self.frameworkReferences is not None or
            self.references is not None or
            self.contentFiles is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='metadataType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='metadataType'):
        if self.minClientVersion is not None and 'minClientVersion' not in already_processed:
            already_processed.add('minClientVersion')
            outfile.write(' minClientVersion=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.minClientVersion), input_name='minClientVersion')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='metadataType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.owners is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sowners>%s</%sowners>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.owners), input_name='owners')), namespaceprefix_ , eol_))
        if self.licenseUrl is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slicenseUrl>%s</%slicenseUrl>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.licenseUrl), input_name='licenseUrl')), namespaceprefix_ , eol_))
        if self.projectUrl is not None:
            namespaceprefix_ = self.projectUrl_nsprefix_ + ':' if (UseCapturedNS_ and self.projectUrl_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sprojectUrl>%s</%sprojectUrl>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.projectUrl), input_name='projectUrl')), namespaceprefix_ , eol_))
        if self.iconUrl is not None:
            namespaceprefix_ = self.iconUrl_nsprefix_ + ':' if (UseCapturedNS_ and self.iconUrl_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%siconUrl>%s</%siconUrl>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.iconUrl), input_name='iconUrl')), namespaceprefix_ , eol_))
        if self.requireLicenseAcceptance is not None:
            namespaceprefix_ = self.requireLicenseAcceptance_nsprefix_ + ':' if (UseCapturedNS_ and self.requireLicenseAcceptance_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srequireLicenseAcceptance>%s</%srequireLicenseAcceptance>%s' % (namespaceprefix_ , self.gds_format_boolean(self.requireLicenseAcceptance, input_name='requireLicenseAcceptance'), namespaceprefix_ , eol_))
        if self.developmentDependency is not None:
            namespaceprefix_ = self.developmentDependency_nsprefix_ + ':' if (UseCapturedNS_ and self.developmentDependency_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdevelopmentDependency>%s</%sdevelopmentDependency>%s' % (namespaceprefix_ , self.gds_format_boolean(self.developmentDependency, input_name='developmentDependency'), namespaceprefix_ , eol_))
        ...
        if self.releaseNotes is not None:
            namespaceprefix_ = self.releaseNotes_nsprefix_ + ':' if (UseCapturedNS_ and self.releaseNotes_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sreleaseNotes>%s</%sreleaseNotes>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.releaseNotes), input_name='releaseNotes')), namespaceprefix_ , eol_))
        ...
        if self.serviceable is not None:
            namespaceprefix_ = self.serviceable_nsprefix_ + ':' if (UseCapturedNS_ and self.serviceable_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sserviceable>%s</%sserviceable>%s' % (namespaceprefix_ , self.gds_format_boolean(self.serviceable, input_name='serviceable'), namespaceprefix_ , eol_))
        if self.icon is not None:
            namespaceprefix_ = self.icon_nsprefix_ + ':' if (UseCapturedNS_ and self.icon_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sicon>%s</%sicon>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.icon), input_name='icon')), namespaceprefix_ , eol_))
        ...
        if self.packageTypes is not None:
            namespaceprefix_ = self.packageTypes_nsprefix_ + ':' if (UseCapturedNS_ and self.packageTypes_nsprefix_) else ''
            self.packageTypes.export(outfile, level, namespaceprefix_, namespacedef_='', name_='packageTypes', pretty_print=pretty_print)
        if self.dependencies is not None:
            namespaceprefix_ = self.dependencies_nsprefix_ + ':' if (UseCapturedNS_ and self.dependencies_nsprefix_) else ''
            self.dependencies.export(outfile, level, namespaceprefix_, namespacedef_='', name_='dependencies', pretty_print=pretty_print)
        if self.frameworkAssemblies is not None:
            namespaceprefix_ = self.frameworkAssemblies_nsprefix_ + ':' if (UseCapturedNS_ and self.frameworkAssemblies_nsprefix_) else ''
            self.frameworkAssemblies.export(outfile, level, namespaceprefix_, namespacedef_='', name_='frameworkAssemblies', pretty_print=pretty_print)
        if self.frameworkReferences is not None:
            namespaceprefix_ = self.frameworkReferences_nsprefix_ + ':' if (UseCapturedNS_ and self.frameworkReferences_nsprefix_) else ''
            self.frameworkReferences.export(outfile, level, namespaceprefix_, namespacedef_='', name_='frameworkReferences', pretty_print=pretty_print)
        ...
        if self.contentFiles is not None:
            namespaceprefix_ = self.contentFiles_nsprefix_ + ':' if (UseCapturedNS_ and self.contentFiles_nsprefix_) else ''
            self.contentFiles.export(outfile, level, namespaceprefix_, namespacedef_='', name_='contentFiles', pretty_print=pretty_print)
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
        # validate simple type attributes
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.minClientVersion, 'minClientVersion')
        self.gds_check_cardinality_(self.minClientVersion, 'minClientVersion', required=False)
        # validate simple type children
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.id, 'id')
        ...
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.licenseUrl, 'licenseUrl')
        self.gds_check_cardinality_(self.licenseUrl, 'licenseUrl', min_occurs=0, max_occurs=1)
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.projectUrl, 'projectUrl')
        self.gds_check_cardinality_(self.projectUrl, 'projectUrl', min_occurs=0, max_occurs=1)
        ...
        self.gds_validate_builtin_ST_(self.gds_validate_boolean, self.requireLicenseAcceptance, 'requireLicenseAcceptance')
        self.gds_check_cardinality_(self.requireLicenseAcceptance, 'requireLicenseAcceptance', min_occurs=0, max_occurs=1)
        self.gds_validate_builtin_ST_(self.gds_validate_boolean, self.developmentDependency, 'developmentDependency')
        self.gds_check_cardinality_(self.developmentDependency, 'developmentDependency', min_occurs=0, max_occurs=1)
        ...
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.releaseNotes, 'releaseNotes')
        self.gds_check_cardinality_(self.releaseNotes, 'releaseNotes', min_occurs=0, max_occurs=1)
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.copyright, 'copyright')
        self.gds_check_cardinality_(self.copyright, 'copyright', min_occurs=0, max_occurs=1)
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.language, 'language')
        self.gds_check_cardinality_(self.language, 'language', min_occurs=0, max_occurs=1)
        ...
        self.gds_validate_builtin_ST_(self.gds_validate_boolean, self.serviceable, 'serviceable')
        self.gds_check_cardinality_(self.serviceable, 'serviceable', min_occurs=0, max_occurs=1)
        ...
        # validate complex type children
        self.gds_check_cardinality_(self.repository, 'repository', min_occurs=0, max_occurs=1)
        self.gds_check_cardinality_(self.license, 'license', min_occurs=0, max_occurs=1)
        self.gds_check_cardinality_(self.packageTypes, 'packageTypes', min_occurs=0, max_occurs=1)
        self.gds_check_cardinality_(self.dependencies, 'dependencies', min_occurs=0, max_occurs=1)
        self.gds_check_cardinality_(self.frameworkAssemblies, 'frameworkAssemblies', min_occurs=0, max_occurs=1)
        self.gds_check_cardinality_(self.frameworkReferences, 'frameworkReferences', min_occurs=0, max_occurs=1)
        self.gds_check_cardinality_(self.references, 'references', min_occurs=0, max_occurs=1)
        self.gds_check_cardinality_(self.contentFiles, 'contentFiles', min_occurs=0, max_occurs=1)
        if recursive:
            if self.repository is not None:
...
class repositoryType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, type_=None, url=None, branch=None, commit=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='repositoryType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='repositoryType'):
        ...
        if self.branch is not None and 'branch' not in already_processed:
            ...
            outfile.write(' branch=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.branch), input_name='branch')), ))
        if self.commit is not None and 'commit' not in already_processed:
            already_processed.add('commit')
            outfile.write(' commit=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.commit), input_name='commit')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='repositoryType', fromsubclass_=False, pretty_print=True):
        pass
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
...
class licenseType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, type_=None, version=None, valueOf_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='licenseType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='licenseType'):
        ...
        if self.version is not None and 'version' not in already_processed:
            already_processed.add('version')
            outfile.write(' version=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.version), input_name='version')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='licenseType', fromsubclass_=False, pretty_print=True):
        pass
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
...
class packageTypesType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'packageType': MemberSpec_('packageType', 'packageTypeType', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'packageType', 'type': 'packageTypeType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, packageTypesType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='packageTypesType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='packageTypesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='packageTypesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='packageTypesType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='packageTypesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for packageType_ in self.packageType:
            ...
            packageType_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='packageType', pretty_print=pretty_print)
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
        # validate simple type attributes
        # validate simple type children
        # validate complex type children
        self.gds_check_cardinality_(self.packageType, 'packageType', min_occurs=0, max_occurs=9999999)
        if recursive:
...
class packageTypeType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, packageTypeType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='packageTypeType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='packageTypeType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='packageTypeType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='packageTypeType'):
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
        if self.version is not None and 'version' not in already_processed:
            already_processed.add('version')
            outfile.write(' version=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.version), input_name='version')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='packageTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
...
class dependenciesType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'dependency': MemberSpec_('dependency', 'dependency', 1, 1, {'name': 'dependency', 'type': 'dependency'}, 1),
        'group': MemberSpec_('group', 'dependencyGroup', 1, 1, {'name': 'group', 'type': 'dependencyGroup'}, 1),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, dependenciesType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='dependenciesType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='dependenciesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='dependenciesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='dependenciesType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='dependenciesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class frameworkAssembliesType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'frameworkAssembly': MemberSpec_('frameworkAssembly', 'frameworkAssemblyType', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'frameworkAssembly', 'type': 'frameworkAssemblyType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='frameworkAssembliesType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='frameworkAssembliesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='frameworkAssembliesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='frameworkAssembliesType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='frameworkAssembliesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for frameworkAssembly_ in self.frameworkAssembly:
            namespaceprefix_ = self.frameworkAssembly_nsprefix_ + ':' if (UseCapturedNS_ and self.frameworkAssembly_nsprefix_) else ''
            frameworkAssembly_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='frameworkAssembly', pretty_print=pretty_print)
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
        # validate simple type attributes
        # validate simple type children
        # validate complex type children
        self.gds_check_cardinality_(self.frameworkAssembly, 'frameworkAssembly', min_occurs=0, max_occurs=9999999)
        if recursive:
...
class frameworkAssemblyType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'assemblyName': MemberSpec_('assemblyName', 'xs:string', 0, 0, {'use': 'required'}),
        'targetFramework': MemberSpec_('targetFramework', 'xs:string', 0, 1, {'use': 'optional'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    def __init__(self, assemblyName=None, targetFramework=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='frameworkAssemblyType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='frameworkAssemblyType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='frameworkAssemblyType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='frameworkAssemblyType'):
        if self.assemblyName is not None and 'assemblyName' not in already_processed:
            already_processed.add('assemblyName')
            outfile.write(' assemblyName=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.assemblyName), input_name='assemblyName')), ))
        if self.targetFramework is not None and 'targetFramework' not in already_processed:
            already_processed.add('targetFramework')
            outfile.write(' targetFramework=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.targetFramework), input_name='targetFramework')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='frameworkAssemblyType', fromsubclass_=False, pretty_print=True):
        pass
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
        # validate simple type attributes
        self.gds_validate_builtin_ST_(self.gds_validate_string, self.assemblyName, 'assemblyName')
...
class frameworkReferencesType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'group': MemberSpec_('group', 'frameworkReferenceGroup', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'group', 'type': 'frameworkReferenceGroup'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='frameworkReferencesType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='frameworkReferencesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='frameworkReferencesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='frameworkReferencesType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='frameworkReferencesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class referencesType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'reference': MemberSpec_('reference', 'reference', 1, 1, {'name': 'reference', 'type': 'reference'}, 2),
        'group': MemberSpec_('group', 'referenceGroup', 1, 1, {'name': 'group', 'type': 'referenceGroup'}, 2),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='referencesType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='referencesType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='referencesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class contentFilesType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'files': MemberSpec_('files', 'contentFileEntries', 1, 1, {'name': 'files', 'type': 'contentFileEntries'}, 3),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, contentFilesType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='contentFilesType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='contentFilesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='contentFilesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='contentFilesType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='contentFilesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class filesType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'file': MemberSpec_('file', 'fileType', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'file', 'type': 'fileType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='filesType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='filesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='filesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='filesType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" xmlns:None="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd" ', name_='filesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class fileType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, src=None, target=None, exclude=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='fileType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='fileType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fileType'):
        ...
        if self.exclude is not None and 'exclude' not in already_processed:
            already_processed.add('exclude')
            outfile.write(' exclude=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.exclude), input_name='exclude')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:mstns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"', name_='fileType', fromsubclass_=False, pretty_print=True):
        pass
    def validate_(self, gds_collector, recursive=False):
        self.gds_collector_ = gds_collector
        message_count = len(self.gds_collector_.get_messages())
