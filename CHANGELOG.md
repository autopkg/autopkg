...
- AppDmgVersioner, AppPkgCreator, CodeSignatureVerifier, MunkiImporter, MunkiInstallsItemsCreator, PlistReader, PkgCreator, PkgInfoCreator, SparkleUpdateInfoProvider: added unit tests
