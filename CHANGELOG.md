...
- AppDmgVersioner, AppPkgCreator, CodeSignatureVerifier, MunkiImporter, MunkiInstallsItemsCreator, PkgCreator, PkgInfoCreator, SparkleUpdateInfoProvider: added unit tests
